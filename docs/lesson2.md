...
![只有Start和End的状态](../img/simple_agent_with_golang_docs_lesson1_state_transform.png)
...
![](../img/simple_agent_with_golang_docs_lesson2_2.png)
```go
type Edge struct {
	From types.NodeID
	To types.NodeID
...
![](../img/simple_agent_with_golang_docs_lesson2_3.png)
```
...
![](../img/simple_agent_with_golang_docs_lesson2_4.png)
